...
const realInviteList = _.union(inviteList1, inviteList2)
...
const mutualFriends = _intersection(friendsOfJim, friendsOfBetty)
...
const pur = _.groupBy(purchases, 'company')